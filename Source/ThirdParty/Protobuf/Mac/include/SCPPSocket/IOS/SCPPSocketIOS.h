...
#ifndef SCPPSOCKET_SCPPSOCKETIOS_H
#define SCPPSOCKET_SCPPSOCKETIOS_H
#include "../SCPPSocket.h"
namespace scppsocket
{
    class SCPPSocketIOS :public SCPPSocket
    {
    public:
        SCPPSocketIOS(SocketAddressFamily AddressFamily, SocketType Type, SocketProtocol Protocol);

        SCPPSocketIOS();
        virtual ~SCPPSocketIOS();
...
#endif //SCPPSOCKET_SCPPSOCKETIOS_H
